...
def run_parallel_queries(start, total_articles, num_processes=8):
...
if __name__ == "__main__":
    start         = 17561639  #  12874426   #8187213      #3500000  # 3000000
    total_articles= 21748852 # 17061639   #12374426    #7687213  # 40497704  # Example total number of articles
    run_parallel_queries(start,total_articles, num_processes=8)
